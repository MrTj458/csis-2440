<?php
  ...
  foreach ($planets as $newPlanets) {
    $insert = "INSERT INTO `Planets` (`PlanetName`, `PosX`, `PosY`, `PosZ`, `Desc`) "
  ...
  echo '<br><h2>Making some planets visitable</h2><br><hr>';

  for ($i = 0; $i < sizeof($planets); $i += 2) {
    $update = "UPDATE `Planets` SET `Active` = 'Y' "
  ...
  echo "<br><h2>All planets</h2><hr>";

  $search = 'SELECT * FROM Planets';
